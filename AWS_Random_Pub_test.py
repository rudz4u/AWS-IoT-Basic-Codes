...
clientId = "xxxxxx"                                     # Thing_Name
thingName = "xxxxxx"                                    # Thing_Name
caPath = "AmazonRootCA1.pem"                                      # Root_CA_Certificate_Name
certPath = "xxxxxxxxx-certificate.pem.crt"                            # <Thing_Name>.cert.pem
keyPath = "xxxxxxxxx-private.pem.key"                          # <Thing_Name>.private.key
